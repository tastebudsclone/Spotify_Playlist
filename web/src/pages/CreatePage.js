...
function CreatePage() {
  return (
    <div className='bg-gray-800 w-full h-screen p-4 font-mono' >
      <BackButton path='/' />
       <p className='text-gray-300 mx-4 text-justify font-bold text-xl pt-5 mb-20'>Welcome to our playlist creator! We have two ways to help you find the perfect playlist for you. So, which one do you prefer?</p>
